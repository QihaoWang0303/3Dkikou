...
static char* g_TextureName[] = {
	...
	"data/TEXTURE/snowfield.png",
	"data/TEXTURE/snowfield002.png",
};
...
{
	return sinf(x * 0.1f) * cosf(z * 0.1f) * 10.0f;
}
//=============================================================================
// 初期化処理
//=============================================================================
	...
	int nNumBlockX, int nNumBlockZ, float fBlockSizeX, float fBlockSizeZ)
{
	...
	for (int z = 0; z < (g_nNumBlockZField + 1); z++)
	{
		for (int x = 0; x < (g_nNumBlockXField + 1); x++)
		{
			...
			//1
			//float height = SimpleNoise(g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.x,g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.z);
			//g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = height;
			 
		
			//2
			g_Vertex[z * (g_nNumBlockXField + 1) + x].Position.y = rand() % 10;
